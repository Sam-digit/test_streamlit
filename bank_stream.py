...
# Définir les fonctions de chargement et sauvegarde
...
def show_loading_message(model_name):
    """
    Affiche un message de chargement dans Streamlit.
    """
...
def check_models_loaded(model_name):
    """
    Vérifie si le modèle spécifié est chargé dans le session_state.
    :param model_name: Nom du modèle à vérifier ('model_rf', 'model_xgb', 'model_lgb')
...
def get_model(model_name):
    """
    Obtient un modèle à partir de st.session_state.
    """
    if model_name == 'rf':
...
En identifiant les facteurs clés de succès des campagnes précédentes, nous pouvons aider l'institution financière à optimiser ses ressources marketing, à cibler plus efficacement ses clients et à améliorer ses taux de conversion, générant ainsi des revenus supplémentaires.
   ...
   with col2:
        # Chemin de l'image
        image_path_intro = "https://raw.githubusercontent.com/Sam-digit/bank_ML/main/images/intro.jpeg"
        #Afficher l'image
...
target = df['deposit']
       ...
       # Chemin de l'image
       image_path_traintest = "https://raw.githubusercontent.com/Sam-digit/bank_ML/main/images/traintest.jpg"
       #Afficher l'image
...
- **OrdinalEncoder** des variables ordinales : 'age', 'education'.
    ...
    with tab4:
       ...
       # Chemin de l'image
       image_path_pipeline = "https://raw.githubusercontent.com/Sam-digit/bank_ML/main/images/pipeline.jpg"
       #Afficher l'image
...
- Decision Tree
        ...
        # Chemin de l'image
        image_path_perf11 = "https://raw.githubusercontent.com/Sam-digit/bank_ML/main/images/perf11.png"
        #Afficher l'image
       ...
       ['Random Forest', 'XGBoost', 'LightGBM']
        ...
        image_paths = {
       'Random Forest': "https://raw.githubusercontent.com/Sam-digit/bank_ML/main/images/fi_rf.png",
       'XGBoost': "https://raw.githubusercontent.com/Sam-digit/bank_ML/main/images/fi_xg.png",
       'LightGBM': "https://raw.githubusercontent.com/Sam-digit/bank_ML/main/images/fi_gbm.png"
       }
...
- A noter également que le modèle XGBoost accorde plus d'importance à la variable **'poutcome_success'** (résultats de la précédente campagne) dans ses prédictions.
    ...
    with tab3:
        ...
        st.markdown("##### Performances")
        # Chemin de l'image
        image_path_perfsd = "https://raw.githubusercontent.com/Sam-digit/bank_ML/main/images/perfsd.jpg"
        #Afficher l'image
...
\nRegardons juste avant les **Feature importances** sans la prépondérance de duration. 
       ...
       key='feature_importances_selectbox'
        ...
        # Définir les chemins des images
        image_paths2 = {
       'Random Forest': "https://raw.githubusercontent.com/Sam-digit/bank_ML/main/images/fisd_rf.png",
       'XGBoost': "https://raw.githubusercontent.com/Sam-digit/bank_ML/main/images/fisd_xg.png",
       'LightGBM': "https://raw.githubusercontent.com/Sam-digit/bank_ML/main/images/fisd_gbm.jpg"
       }
        # Afficher l'image en fonction de la sélection
...
- La variable **"poutcome_success'** reste la plus importante pour le modèle XGBoost.
    ...
    with tab5:
        ...
        if not button_clicked or button5:
            ...
            # Afficher le spinner de chargement pour le modèle Random Forest
            if not check_models_loaded('model_rf'):
                with st.spinner('Chargement du modèle Random Forest, veuillez patienter...'):
                    st.session_state['model_rf'] = async_load_model('random_forest_model.pkl')
        ...
        if  button6:
            ...
            # Afficher le spinner de chargement pour le modèle LightGBM
            if not check_models_loaded('model_lgb'):
                with st.spinner('Chargement du modèle LightGBM, veuillez patienter...'):
                    st.session_state['model_lgb'] = async_load_model('lightgbm_model.pkl')
        ...
        if  button8:
            ...
            if results_rf is not None and results_xgb is not None and results_lgb is not None:
                ...
                fig.update_layout(
                    height=500,  # Hauteur personnalisée en pixels
...
- Revoir aussi l'approche client et le discours pour toucher d'autres cibles
       ...
       with col2:
          # Chemin de l'image
          image_path_persona = "https://raw.githubusercontent.com/Sam-digit/bank_ML/main/images/persona.png"
          #Afficher l'image
